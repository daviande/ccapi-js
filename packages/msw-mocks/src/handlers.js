...
export const handlers = [
  http.get(/\/ccapi\/ver100\/shooting\/settings\/shootingmode/, () => {
  ...
  http.put(/\/ccapi\/ver100\/shooting\/settings\/av/, async ({ request }) => {
    const requestBody = await request.json();
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/tv/, () => {
    return HttpResponse.json({
  ...
  http.put(/\/ccapi\/ver100\/shooting\/settings\/tv/, async ({ request }) => {
    const requestBody = await request.json();
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/iso/, () => {
    return HttpResponse.json({
  ...
  http.put(/\/ccapi\/ver100\/shooting\/settings\/iso/, async ({ request }) => {
    const requestBody = await request.json();
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/exposure/, () => {
    return HttpResponse.json({
  ...
  http.get(/\/ccapi\/ver100\/shooting\/liveview\/flipdetail/, async () => {
    const buffer = fs.readFileSync(
      path.resolve(import.meta.dirname, "flipdetail"),
    );
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/drive/, () => {
    return HttpResponse.json({
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/aeb/, () => {
    return HttpResponse.json({
  ...
  http.put(/\/ccapi\/ver100\/shooting\/settings\/aeb/, async ({ request }) => {
    const requestBody = await request.json();
  ...
  http.get(/\/ccapi\/ver100\/shooting\/settings\/focusbracketing/, () => {
    return HttpResponse.json({
